...
The `iDispatch Logger` maintainers take all security issues in the project
seriously. Thank you for improving the security of `iDispatch Logger`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`iDispatch Logger` leverages GitHub's private vulnerability reporting.
